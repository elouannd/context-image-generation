...
export const PROVIDERS = {
    ...
    tokenreply: {
        ...
        models: [{ id: 'grok-imagine-image', label: 'Grok Imagine Image (Experimental)', transport: 'openAiImages', supportsReferenceImages: false, modelNote: 'Experimental: TokenReply Grok uses a minimal text-only OpenAI Images request. Image size and reference images are not sent.', status: 'experimental' }],
    },
    openrouter: {
        id: 'openrouter',
        label: 'OpenRouter',
